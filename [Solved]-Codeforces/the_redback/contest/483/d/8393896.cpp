...
void update(int node, int low, int high, int rlow, int rhigh, ll value,int flag)
{
    ...
    if(rhigh <= mid)
        update(left, low, mid, rlow, rhigh, value,flag);
    else if(rlow > mid)
        update(right, mid+1, high, rlow, rhigh, value,flag);
    else
    {
        update(left, low, mid, rlow, mid, value,flag/2);
        update(right, mid+1, high, mid+1, rhigh, value,flag/2);
    }
}
