...
private:
    ...
    void test_case_0() {
        ...
        string Arg1 = "cl";
        verify_case(0, Arg1, simulate(Arg0));
    }
    void test_case_1() {
        string Arg0 = "topcoder";
        string Arg1 = "topcoder";
        verify_case(1, Arg1, simulate(Arg0));
    }
    void test_case_2() {
        string Arg0 = "abcdefghijklmnopqrstuvwxyyxwvutsrqponmlkjihgfedcba";
        string Arg1 = "";
        verify_case(2, Arg1, simulate(Arg0));
    }
    void test_case_3() {
        string Arg0 = "bacaabaccbaaccabbcabbacabcbba";
        string Arg1 = "bacbaca";
        verify_case(3, Arg1, simulate(Arg0));
    }
    void test_case_4() {
        string Arg0 = "eel";
        string Arg1 = "l";
        verify_case(4, Arg1, simulate(Arg0));
    }
