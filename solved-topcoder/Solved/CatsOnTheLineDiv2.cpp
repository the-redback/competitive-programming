...
bool comp(D aa, D bb) { return aa.pos < bb.pos; }
...
struct CatsOnTheLineDiv2 {
    string getAnswer(vector<int> position, vector<int> count, int time) {
        ...
        for (i = 0; i < n; i++) {
            ...
            if (cnt < a[i].cnt) return "Impossible";
        }
...
private:
    ...
    void test_case_0() {
        ...
        verify_case(0, Arg3, getAnswer(Arg0, Arg1, Arg2));
    }
    void test_case_1() {
        int Arr0[] = {0};
        vector<int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        ...
        verify_case(1, Arg3, getAnswer(Arg0, Arg1, Arg2));
    }
    void test_case_2() {
        int Arr0[] = {0, 1};
        vector<int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        ...
        int Arg2 = 0;
        string Arg3 = "Impossible";
        verify_case(2, Arg3, getAnswer(Arg0, Arg1, Arg2));
    }
    void test_case_3() {
        int Arr0[] = {5, 0, 2};
        vector<int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0])));
        ...
        int Arg2 = 2;
        string Arg3 = "Impossible";
        verify_case(3, Arg3, getAnswer(Arg0, Arg1, Arg2));
    }
    void test_case_4() {
        ...
        int Arg2 = 6;
        string Arg3 = "Possible";
        verify_case(4, Arg3, getAnswer(Arg0, Arg1, Arg2));
    }
